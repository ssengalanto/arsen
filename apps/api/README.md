...
Go backend for Arsen with JWT authentication, vertical slice architecture, and CQRS.

This is the API workspace within the monorepo. For the full project overview, see the root [README](../../README.md).
...
- Docker multi-stage build (dev with Air hot reload, prod with distroless)
